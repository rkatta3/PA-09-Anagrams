...
1. Find all words that can be formed from subsets of letters in the phrase
2. Use only these words as "choices" in the decision tree (for efficiency)
3. Recursively choose words that use letters from the phrase
4. Backtrack when no valid choices remain or max words exceeded
5. Print complete anagrams that use all letters
